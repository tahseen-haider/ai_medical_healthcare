...
export default function ContactUsPage() {
  ...
  return (
    <main className="min-h-screen w-full flex flex-col items-center">
      <div className="w-full bg-gradient-to-b to-light-4 from-gray-50 dark:to-dark-4 dark:from-gray-950">
        <div className="mx-auto w-full max-w-6xl px-2 md:px-4 py-2 md:py-8">
          ...
          <div className="text-center mb-4 md:mb-12">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Have a question or suggestion? We're here to help and would love
              to hear from you.
            </p>
          </div>
