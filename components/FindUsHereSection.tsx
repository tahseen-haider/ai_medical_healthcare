...
export default function FindUsHereSection() {
  return (
    <section className="w-full overflow-hidden bg-gradient-to-b from-light-4 to-gray-50 dark:from-dark-4 dark:to-gray-950">
      <div className="flex flex-col px-4 sm:px-6 py-10 sm:py-20 gap-10 w-full max-w-screen-xl mx-auto">
        {/* Section Title */}
        <h2 className="font-bold text-white text-3xl sm:text-4xl tracking-tight">
          Find Us Here
        </h2>
