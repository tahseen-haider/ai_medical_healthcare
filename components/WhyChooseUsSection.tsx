...
export default function WhyChooseUsSection() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b to-light-4 from-gray-50 dark:to-dark-4 dark:from-gray-950 w-full py-12 sm:py-16 px-4 sm:px-8 lg:px-16">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-10">
        ...
        <div className="w-full lg:w-1/2 space-y-4 sm:space-y-6">
          ...
          <p className="text-base sm:text-lg leading-relaxed text-gray-700 dark:text-gray-200">
            ...
            <br />
            <br />
            Backed by real medical expertise, we offer 24/7 support you can
            trust — all in one easy‑to‑use platform.
          </p>
